...
import '../../fans/screens/matchwatch1.dart';
...
class PLayout extends StatefulWidget {
  EventM matches;
  PLayout({super.key,required this.matches});

  @override
  State<PLayout> createState() => _PLayoutState();
}
                      ...
                      children: [
                        TextButton(onPressed: (){
                          Navigator.push(context,
                            MaterialPageRoute(builder: (context)=> Matchwatch1(event:widget.matches),
                            ),
                          );
