...
import '../../professionals/screens/leaguesprofessionals.dart';
import '../screens/legues.dart';
class EventsProfessionalsbottombar extends StatefulWidget {
  const EventsProfessionalsbottombar({super.key});

  @override
  State<EventsProfessionalsbottombar> createState() => _EventsProfessionalsbottombarState();
}

class _EventsProfessionalsbottombarState extends State<EventsProfessionalsbottombar> {
                        ...
                        if (MediaQuery.of(context).size.height >650) {
                          return Align(
                            ...
                            child:  Container(
                              ...
                              width: MediaQuery.of(context).size.width * 0.6915,
