...
class EventsClubsbottombar extends StatefulWidget {
  const EventsClubsbottombar({super.key});

  @override
  State<EventsClubsbottombar> createState() => _EventsClubsbottombarState();
}

class _EventsClubsbottombarState extends State<EventsClubsbottombar> {
