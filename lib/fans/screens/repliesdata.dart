...
class Repliesdata extends StatefulWidget {
  String postId;
  String commentId;

   Repliesdata({super.key,
     required this.commentId,
     required this.postId,});

  @override
  State<Repliesdata> createState() => _RepliesdataState();
}

class _RepliesdataState extends State<Repliesdata> {
