...
class Moreinfofans extends StatefulWidget {
  String userId;
  Moreinfofans({super.key,required this.userId});
  @override
  State<Moreinfofans> createState() => _MoreinfofansState();
}
class _MoreinfofansState extends State<Moreinfofans> {
